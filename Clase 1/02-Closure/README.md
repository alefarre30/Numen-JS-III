...
saludarHola('Cristian'); // 'Hola Cristian'
```
...
logNombre.call(persona, 'Hola', ', Cómo estas?'); //Hola Cristian Chequer , Cómo estas?
```
...
logNombre.apply(persona, ['Hola', ', Cómo estas?']); //Hola Cristian Chequer , Cómo estas?
```
